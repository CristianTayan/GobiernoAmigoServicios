...
use GobiernoAmigoMovil\DAO\UsuarioFilterByIdentificacion;

/**
 * Class FilterByColumns
 * @package OkayBueno\Repositories\Criteria\src
 */
class UsuarioFilterByIdentificacionImpl implements UsuarioFilterByIdentificacion
{
    private $filter;
    ...
    {
        $modelOrBuilder = $modelOrBuilder->where('identificacion','=',  $this->filter);
