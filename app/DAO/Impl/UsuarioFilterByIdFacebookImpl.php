...
use GobiernoAmigoMovil\DAO\UsuarioFilterByIdFacebook;

/**
 * Class FilterByColumns
 * @package OkayBueno\Repositories\Criteria\src
 */
class UsuarioFilterByIdFacebookImpl implements UsuarioFilterByIdFacebook
{
    private $filter;
    ...
    {
        $modelOrBuilder = $modelOrBuilder->where('idfacebook','=',  $this->filter);
