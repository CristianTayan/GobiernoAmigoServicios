...
use GobiernoAmigoMovil\DAO\UsuarioFilterByMovil;

/**
 * Class FilterByColumns
 * @package OkayBueno\Repositories\Criteria\src
 */
class UsuarioFilterBymovilImpl implements UsuarioFilterByMovil
{
    private $filter;
    ...
    {
        $modelOrBuilder = $modelOrBuilder->where('movil','=',  $this->filter);
