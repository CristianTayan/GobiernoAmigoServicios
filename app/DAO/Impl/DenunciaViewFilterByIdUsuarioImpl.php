...
use GobiernoAmigoMovil\DAO\DenunciaViewFilterByIdUsuario;

/**
 * Class FilterByColumns
 * @package OkayBueno\Repositories\Criteria\src
 */
class DenunciaViewFilterByIdUsuarioImpl implements DenunciaViewFilterByIdUsuario
{
    private $filter;
    ...
    {
        $modelOrBuilder = $modelOrBuilder->where('id_usuario_denuncia','=',  $this->filter);
