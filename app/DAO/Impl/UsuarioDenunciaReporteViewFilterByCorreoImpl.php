...
use GobiernoAmigoMovil\DAO\UsuarioDenunciaReporteViewFilterByCorreo;

/**
 * Class FilterByColumns
 * @package OkayBueno\Repositories\Criteria\src
 */
class UsuarioDenunciaReporteViewFilterByCorreoImpl implements UsuarioDenunciaReporteViewFilterByCorreo
{
    private $filter;
    ...
    {
        $modelOrBuilder = $modelOrBuilder->where('correo_usuario','=',  $this->filter);
